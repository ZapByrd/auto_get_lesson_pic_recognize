...
def WorkFunction1(sheet):
    ...
    while i < sheet.nrows:
        ...
        # 2：输入字符串
            ...
            pyautogui.hotkey('ctrl', 'v')  # 使用hotkey()按下快捷键，同时按两个不松开
